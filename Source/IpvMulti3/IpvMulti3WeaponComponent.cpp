...
bool UIpvMulti3WeaponComponent::AttachWeapon(AIpvMulti3Character* TargetCharacter)
{
	...
	if (Character == nullptr || Character->GetInstanceComponents().FindItemByClass<UIpvMulti3WeaponComponent>())
	{
		return false;
	}
	...
	if (APlayerController* PlayerController = Cast<APlayerController>(Character->GetController()))
	{
		...
		{
			// Fire
			EnhancedInputComponent->BindAction(FireAction, ETriggerEvent::Triggered, this, &UIpvMulti3WeaponComponent::Fire);
		}
	}
